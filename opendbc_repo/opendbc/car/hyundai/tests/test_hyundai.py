...
class TestHyundaiFingerprint:
  def test_carnival_hev_low_speed_torque_rate_limits(self):
    ...
    carnival_2024_cp = CarInterface.get_params(CAR.KIA_CARNIVAL_4TH_GEN, gen_empty_fingerprint(), [],
                                                False, False, False, None)
    carnival_2024_low_speed = CarControllerParams(carnival_2024_cp, 10.0)
    carnival_2024_high_speed = CarControllerParams(carnival_2024_cp, 20.0)
    ...
    assert (carnival_2024_low_speed.STEER_DELTA_UP, carnival_2024_low_speed.STEER_DELTA_DOWN) == (10, 8)
    assert (carnival_2024_high_speed.STEER_DELTA_UP, carnival_2024_high_speed.STEER_DELTA_DOWN) == (10, 10)
