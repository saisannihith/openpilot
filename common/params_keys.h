...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"LaneCenteringRoadAware", {PERSISTENT, BOOL, "0", "0", 3}},
    {"LaneCenteringRoadEdgeOffset", {PERSISTENT, FLOAT, "0.15", "0.15", 3}},
    ...
    {"CarnivalRevertProfile", {CLEAR_ON_MANAGER_START, BOOL, "0", "0", 2}},
    {"CarnivalAnalysisRunning", {CLEAR_ON_MANAGER_START, BOOL, "0", "0", 2}},
    {"CarnivalAnalysisError", {PERSISTENT, STRING, "", "", 2}},
    {"CarnivalLastAnalysisRoute", {PERSISTENT, STRING, "", "", 2}},
    {"CarnivalLastAnalysisTime", {PERSISTENT, STRING, "", "", 2}},
    {"CarnivalLastReportPath", {PERSISTENT, STRING, "", "", 2}},
    {"CarnivalLastScorecard", {PERSISTENT, JSON, "{}", "{}", 2}},
    {"CarnivalPendingProfile", {PERSISTENT, JSON, "{}", "{}", 2}},
    {"CarnivalProfileSnapshot", {PERSISTENT, JSON, "{}", "{}", 2}},
    {"StarPilotQuickControlOrder", {PERSISTENT, JSON, "[]", "[]", 0}},
